...
import { Phone, Ambulance, Calendar, Clock, MapPin, User, Mail, MessageSquare, X } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded">
                <div className="flex items-center">
                  ...
                  <strong>Medical Emergency?</strong> If this is a medical emergency, please call 911 or our emergency line at (281) 690-1274 immediately.
                </div>
              </div>
            </form>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 font-semibold">(281) 690-1274</p>
