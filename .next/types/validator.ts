...
// Validate ../../src/app/api/booking-simple/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/booking-simple">> = Specific
  const handler = {} as typeof import("../../src/app/api/booking-simple/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/booking-test/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/booking-test">> = Specific
  const handler = {} as typeof import("../../src/app/api/booking-test/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
